...
export default function SkinsModal({ visible, onClose }: Props) {
  ...
  const { selectedSkinId, selectSkin, unlockedSkins, bestScore, coins } = useGame();
        ...
        >
          <LinearGradient colors={['#0A1628', '#060E1A']} style={styles.sheetContent}>
            ...
            <View style={styles.header}>
              <Text style={styles.title}>CHARACTER SKINS</Text>
...
const styles = StyleSheet.create({
  ...
  unlockCoinDot: {
    width: 7, height: 7, borderRadius: 3.5, backgroundColor: COLORS.neonYellow,
  },
  selectedBadge: {
    position: 'absolute',
    top: 8,
