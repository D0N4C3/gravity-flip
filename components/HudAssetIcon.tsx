...
const HUD_ASSETS = {
  ...
  obstacle_moving_spike_floor: require('@/assets/hud/obstacle_moving_spike_floor.svg'),
  obstacle_moving_spike_ceiling: require('@/assets/hud/obstacle_moving_spike_ceiling.svg'),
  obstacle_moving_spike_pincer: require('@/assets/hud/obstacle_moving_spike_pincer.svg'),
  obstacle_spike_wall: require('@/assets/hud/obstacle_spike_wall.svg'),
  obstacle_narrow_tunnel: require('@/assets/hud/obstacle_narrow_tunnel.svg'),
  obstacle_narrow_tunnel_offset: require('@/assets/hud/obstacle_narrow_tunnel_offset.svg'),
